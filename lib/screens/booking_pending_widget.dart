    ...
    DropdownButton _normalDown() => DropdownButton<String>(
        items: [
          ...
          DropdownMenuItem<String>(
            value: "2",
            child: Text(
              "Status: Approved",style: TextStyle(
                                        color: Color.fromARGB(255, 66, 66, 66),
                                        fontSize: 18,
           ...
           DropdownMenuItem<String>(
            value: "3",
            child: Text(
              "Status: Rejected",style: TextStyle(
                                        color: Color.fromARGB(255, 66, 66, 66),
                                        fontSize: 18,
           ...
           DropdownMenuItem<String>(
            value: "4",
            child: Text(
              "Status: Completed",style: TextStyle(
                                        color: Color.fromARGB(255, 66, 66, 66),
                                        fontSize: 18,
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child: FlatButton(
                                                                    onPressed: () => this.onGroupPressed(context),
                                                                                                                                        ...
                                                                                                                                        child: Image.asset("assets/images/001-sort-by-attributes-interface-button-option.png",),
                                                                                                                                    ),
                                                                                                                                ),
                                                                                                                            ),
