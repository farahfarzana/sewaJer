...
class _AddCarDefaultWidgetState extends State<AddCarDefaultWidget> {
  ...
  void onClosePressed(BuildContext context) => Navigator.push(
      context, MaterialPageRoute(builder: (context) => HomeDefaultWidget()));
                    ...
                    child: Container(
                      ...
                      child: FlatButton(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            new Padding(
                                padding: new EdgeInsets.only(left: 23.5)),
                            Text(
                              "Car Details",
                              style: TextStyle(
                                fontSize: 16,
